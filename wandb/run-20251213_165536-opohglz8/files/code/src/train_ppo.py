...
if __name__ == "__main__":
    ...
    envs = FlattenRGBDObservationWrapper(envs, rgb=args.rgb, depth=args.depth, state=args.include_state)
    eval_envs = FlattenRGBDObservationWrapper(eval_envs, rgb=args.rgb, depth=args.depth, state=args.include_state)
